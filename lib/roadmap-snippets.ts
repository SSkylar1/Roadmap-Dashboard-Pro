export const ROADMAP_CHECKER_SNIPPET = [
  ...
  "// Reads docs/roadmap.yml (or docs/projects/<slug>/roadmap.yml) and writes a matching status file",
  "",
  ...
  "const rawSlug = typeof process.env.ROADMAP_PROJECT === \"string\" ? process.env.ROADMAP_PROJECT.trim() : \"\";",
  "const PROJECT_SLUG = rawSlug",
  "  ? rawSlug",
  "      .toLowerCase()",
  "      .replace(/[^a-z0-9-]+/g, \"-\")",
  "      .replace(/-+/g, \"-\")",
  "      .replace(/^-+|-+$/g, \"\")",
  "  : \"\";",
  "const DOCS_ROOT = PROJECT_SLUG",
  "  ? path.join(ROOT, \"docs\", \"projects\", PROJECT_SLUG)",
  "  : path.join(ROOT, \"docs\");",
  "const ROADMAP_YML = path.join(DOCS_ROOT, \"roadmap.yml\");",
  "const STATUS_JSON = path.join(DOCS_ROOT, \"roadmap-status.json\");",
  "",

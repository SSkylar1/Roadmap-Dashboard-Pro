        ...
        <div className="container">
          <header className="tw-flex tw-flex-col tw-gap-4 tw-mb-6">
            <div className="tw-flex tw-flex-wrap tw-items-start tw-justify-between tw-gap-4">
              ...
              <nav className="tw-flex tw-w-full tw-flex-wrap tw-gap-2 tw-pt-1 tw-text-sm sm:tw-w-auto sm:tw-justify-end">
                <Link
                  href="/"
                  className="tw-inline-flex tw-items-center tw-gap-2 tw-rounded-full tw-border tw-border-slate-800 tw-px-3 tw-py-1 tw-font-medium tw-text-slate-300 tw-transition tw-duration-200 tw-ease-out hover:tw-border-slate-700 hover:tw-text-slate-100"
                >
                  <span>Dashboard</span>
                </Link>
                <Link
